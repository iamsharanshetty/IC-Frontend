    ...
    try {
      ...
      if (error instanceof ApiError) {
        switch (error.status) {
          ...
          case 500:
            errorMessage =
              "Server error during processing. Please try again later.";
            break;
          default:
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Upload your institutional reports for AI-powered claim verification.
          ...
          <div className="mt-4">
            ...
            {backendStatus === "disconnected" && (
              <Alert className="mt-2" variant="destructive">
                ...
                <AlertDescription>
                  Cannot connect to the analysis backend. Please ensure the
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Drag and drop your files here or click to browse. Maximum file
              size: 1MB per file.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {hasErrors && (
          <Alert className="mb-6" variant="destructive">
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              Some files failed to upload. Please check the file formats and
              sizes, then try again.
            </AlertDescription>
          </Alert>
        )}
